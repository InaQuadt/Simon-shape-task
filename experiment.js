...
var correct_responses = jsPsych.randomization.shuffle([["F", 70],["J", 74]])
var choices = [70, 74]
var current_trial = 0
var gap = Math.floor(Math.random() * 2000) + 1000
var test_stimuli = [{
  stimulus: '<div class = centerbox><img src="https://inaquadt.github.io/Simon-shape-task/img/orange.png" class="simon_left" /></div>',
  data: {
  ...
  stimulus: '<div class = centerbox><img src="https://inaquadt.github.io/Simon-shape-task/img/orange.png" class="simon_right" /></div>',
  data: {
    correct_response: correct_responses[0][1],
    stim_side: 'right',
    stim_color: 'red',
  ...
  stimulus: '<div class = simon_leftbox><img src="https://inaquadt.github.io/Simon-shape-task/img/blue.png" class="simon_left" /></div>',
  data: {
  ...
  stimulus: '<div class = simon_rightbox><img src="https://inaquadt.github.io/Simon-shape-task/img/blue.png" class="simon_right" /></div>',
  data: {
    correct_response: correct_responses[1][1],
    stim_side: 'right',
    stim_color: 'blue',
